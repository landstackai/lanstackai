...

{
  ...
  "water": "None" | "Wet" | "Seasonal" | "Live" | null,    // infer from description if mentioned
  "road_frontage": "None" | "Easement" | "County" | "State" | "Interstate" | null,
  "has_improvements": boolean,            // infer from description
